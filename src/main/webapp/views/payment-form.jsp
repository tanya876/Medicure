...
<input type="text" name="patientId" value=${patient.patientId}>
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <input type="text" id="ccnum"  placeholder="Enter 16 digit card number">
            <label for="expmonth">Exp Month</label>
            <input type="text" id="expmonth" placeholder="Enter expiry month">
            <div class="row" style="margin: 0px 0px;">
              <div class="col-50">
                <label for="expyear">Exp Year</label>
                <input type="text" id="expyear"  placeholder="Enter expiry year">
              </div>
              <div class="col-50">
                <label for="cvv">CVV</label>
                <input type="text" id="cvv"  placeholder="Enter 3 digit CVV number">
              </div>
            </div>
          </div>
  ...
  <div class="col-25">
    <div class="container1">
      ...
      <p><a href="#">Appointment id-17</a> <span class="price">Rs. 700</span></p>
