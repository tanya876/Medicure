...
<a href="list">View Records</a>
               ...
               <a href="patient/login" class="w3-button w3-white w3-padding-large w3-large w3-margin-top" style="color:black;padding: 8px 10px!important;margin-top: 0px!important;margin-left: 8px;">Login</a>
